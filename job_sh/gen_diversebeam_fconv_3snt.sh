...
beam=63; subset="test"; top=3; prefix=0; path="/gs/hs0/tga-nlp-titech/matsumaru/entasum/fairseq_model/jnc_3snt_fconv_200k_test"; \
...
> ${path}_gen/beam${beam}_DBS_prefix${prefix}.out
